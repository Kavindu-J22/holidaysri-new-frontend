                    ...
                    <>
                      {filteredProducts.map((product, index) => (
                        ...
                        >
                          ...
                          >
                            <Box width={{ lg: '100%' }} height={{ lg: '200px' }}>
...
{' '}
                    ...
                    {!loading && <>
                      <EmptyNotification
                        ...
                        body={`Currently, there are no vehicles around ${locationname}`}
                        width={{
                          lg: "850px",
                          xs: "350px",
                          md: "auto",
                        ...
                        marginLefts={{lg:'19%',xs:'6%',sm:'20%',md:'25%',xl:'21%'}}
                      />
                    </>
                    }
                ...
                {selectedEvent && (
                  <>
                    <Typography
                      ...
                      color="white"
                    >
                      Vehicle Category: {selectedEvent.Vehiclecategory}
                    </Typography>
                    <Grid container>
