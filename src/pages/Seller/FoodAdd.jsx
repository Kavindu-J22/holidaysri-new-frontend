...
const FoodAdd = (props) => {
  ...
  const [categoryFilter, setCategoryFilter] = useState("food");
    ...
    >
      ...
      >
        ...
        <Typography
          ...
          marginTop="32px"
        >
          {categoryFilter === "all" ? "All Products" : `All ${categoryFilter} items`}
        </Typography>
      </Box>
      ...
      <Box
          sx={{
            width: { lg: "300px", xs: "280px" },
            marginLeft: { lg: "11%", xs: "32%" },
          }}
        >
      <Typography
