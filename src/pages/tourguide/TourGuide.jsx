...
const TourGuide = () => {
  ...
  return (
    ...
    >
      ...
      <Grid item xs={12}>
        <Box marginBottom="0px" marginTop={{lg:"80px",xs:"90px"}} marginLeft="16px">
                ...
                <Grid item xs={12} lg={3} sm={4} md={4} key={index}>
                  ...
                  >
                    ...
                    >
                      ...
                      {(<>
                                <Box sx={{height:'250px'}}>
                        <img style={{width:'100%',height:'100%'}} src={partner.profileImage} />
                  ...
                  {!loading && <>
                    <>
                      <EmptyNotification
                        ...
                        body={`Currently, there are no tour guides in this area`}
                        width={{
                          lg: "850px",
                          xs: "350px",
                          md: "700px",
