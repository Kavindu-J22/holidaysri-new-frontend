...
import {
  AccountCircle, Notifications, Group, Dashboard, Home,Chat, Logout, Menu as MenuIcon
    ...
    <div>
      ...
      <AppBar position="fixed" sx={{ backgroundColor: '#312a2a80' }}>
        <Toolbar>
          ...
          Holidaysri - Travel Partner Dashboard
          </Typography>
        </Toolbar>
      </AppBar>
      ...
      <Drawer anchor="left" open={isDrawerOpen} onClose={() => toggleDrawer(false)}>
        ...
        >
          <List>
            ...
            <ListItem button onClick={() => setActivePage('Chats')}>
              <ListItemIcon><Chat /></ListItemIcon>
              <ListItemText primary="Chats" />
            </ListItem>
            <ListItem button onClick={() => navigate('/all-partners')}>
              <ListItemIcon><Group /></ListItemIcon>
              <ListItemText primary="View All Travel Partners" />
            </ListItem>
...
const Notification = () => (
  <div>
    ...
    <p>Here is the list of notifications for the Travel Partner.</p>
  </div>
);
...
const Chats = () => (
  <div>
    ...
    <p>Here is the list of Chats for the Travel Partner.</p>
  </div>
);
...
const ViewAllGuiders = () => (
  <div>
    <Typography variant="h4">View All Travel Partner</Typography>
