...
const MyPartnerDetailsPage = () => {
  ...
  const handleRepublishHotel = async (partnerId) => {
    try {
        ...
        "https://holidaysri-backend.onrender.com/api/partner/partner-update-expiredate", 
        {
            _id: partnerId, 
            newExpirationDate,
        ...
        // Show success alert
        alert("Partner Profile Republished successfully!");
        // Navigate to the correct dashboard
        navigate("/Partner-Dashboard");

    } catch (error) {
        console.error("Error updating expiration date partner:", error);
        alert("Error updating expiration date partner : " + error.message);
    }
    };
              ...
              <Box sx={{ display: "flex", alignItems: "center", marginBottom: "8px" }}>
                ...
                <span style={{fontWeight:"600"}}>Description :</span> {currentUserPartner.bio}
                        ...
                        <Button
                          ...
                          onClick={() => handleRepublishHotel(currentUserPartner._id)}
                        >
                          Re-Publish Profile
                        </Button>
