...
const CheckoutPageUpdate = () => {
  ...
  useEffect(() => {
    ...
    if (location.state) {
      const { discount, rate, path, currency, items, earns, postFunctionData } = location.state;
  ...
  const handleApplyPromoCode = async () => {
    try {
      ...
      if (response.data.error) {
        ...
        setPromoCodeInfo({ userName: response.data.userName, discount: discountPercentage });
...
export default CheckoutPageUpdate;
