...
const PayHerePageUsers = () => {
  ...
  const subrole = location.state?.data.data.subrole;
  ...
  const partnerProfileImage = location.state?.data.data.partnerProfileImage;

  const gender = location.state?.data.data.gender; //new
  const age = location.state?.data.data.age; //new
  const interest = location.state?.data.data.interest; //new
  const bio = location.state?.data.data.bio; //new
  ...
  }, [redirectPath, subrole,name,nic,emailsub,contactNumber,password,partnerProfileImage,gender,age,interest,bio]);
...
export default PayHerePageUsers;