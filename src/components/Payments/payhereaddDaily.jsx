...
const PayHereDailyLiveRide = () => {
  ...
  const vehicleID = location.state?.data.data.vehicleID;
  const Route = location.state?.data.data.Route;
  const vehicleOwnerName = location.state?.data.data.vehicleOwnerName;
  const Maximum = location.state?.data.data.Maximum;
  const phoneNumber = location.state?.data.data.phoneNumber;
  const emailsub = location.state?.data.data.email;
  const price = location.state?.data.data.price;
  const Availability = location.state?.data.data.Availability;
  const CurrentLocation = location.state?.data.data.CurrentLocation;
  const Description = location.state?.data.data.Description;
  const Status = location.state?.data.data.Status;
  const images = location.state?.data.data.images;
  const rideDate = location.state?.data.data.rideDate;
  const rideTime = location.state?.data.data.rideTime;
  const ApxTime = location.state?.data.data.ApxTime;
  const expirationDate = location.state?.data.data.expirationDate;
    ...
    script.onload = () => {
      window.payhere.onCompleted = async function onCompleted(orderId) {
        ...
        const data = {
            ...
            images,
            ApxTime,
            DailyOrMonth: "Daily", // Always set to daily
            expirationDate
        };
  ...
  }, [redirectPath,vehicleID,Route,emailsub,Maximum,price,phoneNumber,Availability,CurrentLocation,Description,Status,rideDate,rideTime,images,ApxTime,expirationDate]);
...
export default PayHereDailyLiveRide;
