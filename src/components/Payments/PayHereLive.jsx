...
const PayHerePageLive = () => {
  ...
  const subscription = location.state?.data.data.subscription;
      ...
      window.payhere.onCompleted = async function onCompleted(orderId) {
        ...
        try {
          ...
          if (response.ok) {
            ...
            console.log('Data sent to backend successfully1!');
  ...
  }, [redirectPath, vehicleID, Route,vehicleOwnerName,Maximum,phoneNumber,subscription,email,Availability,CurrentLocation,Description,Status,images, navigate]);
...
export default PayHerePageLive;
