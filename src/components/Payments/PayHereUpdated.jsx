...
const PayHerePageUpdated = () => {
  ...
  const productName = location.state?.data.data.productName;
  const category = location.state?.data.data.category;
  const userEmail = location.state?.data.data.email;
  const locationData = location.state?.data.data.location;
  ...
  }, [redirectPath, productName, category, userEmail, locationData, description, subscription, price, images, contactNumber]);
...
export default PayHerePageUpdated;
